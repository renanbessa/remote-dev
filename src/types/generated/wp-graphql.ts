...
export type Category = DatabaseIdentifier &
  ...
  UniformResourceIdentifiable & {
    ...
    /** Connection between the category type and the Vaga type */
    vagas?: Maybe<CategoryToVagaConnection>
  }
...
/** The category type */
export type CategoryVagasArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<CategoryToVagaConnectionWhereArgs>
}
...
/** Connection between the category type and the Vaga type */
export type CategoryToVagaConnection = {
  __typename?: 'CategoryToVagaConnection'
  /** Edges for the CategoryToVagaConnection connection */
  edges?: Maybe<Array<Maybe<CategoryToVagaConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Vaga>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
}

/** An edge in a connection */
export type CategoryToVagaConnectionEdge = {
  __typename?: 'CategoryToVagaConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The item at the end of the edge */
  node?: Maybe<Vaga>
...
/** Arguments for filtering the CategoryToVagaConnection connection */
export type CategoryToVagaConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars['Int']>
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars['ID']>>>
...
/** Input for the createVaga mutation */
export type CreateVagaInput = {
  /** The userId to assign as the author of the object */
  authorId?: Maybe<Scalars['ID']>
  /** Set connections between the Vaga and categories */
  categories?: Maybe<VagaCategoriesInput>
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>
  /** The content of the object */
  content?: Maybe<Scalars['String']>
  ...
  /** The status of the object */
  status?: Maybe<PostStatusEnum>
  /** Set connections between the Vaga and tags */
  tags?: Maybe<VagaTagsInput>
  /** The title of the object */
  title?: Maybe<Scalars['String']>
}

/** The payload for the createVaga mutation */
export type CreateVagaPayload = {
  __typename?: 'CreateVagaPayload'
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>
  /** The Post object mutation type. */
  vaga?: Maybe<Vaga>
...
/** Input for the deleteVaga mutation */
export type DeleteVagaInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars['Boolean']>
  /** The ID of the Vaga to delete */
  id: Scalars['ID']
}

/** The payload for the deleteVaga mutation */
export type DeleteVagaPayload = {
  __typename?: 'DeleteVagaPayload'
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>
...
export type RootMutation = {
  ...
  /** The payload for the createVaga mutation */
  createVaga?: Maybe<CreateVagaPayload>
  /** The payload for the deleteCategory mutation */
  ...
  /** The payload for the deleteVaga mutation */
  deleteVaga?: Maybe<DeleteVagaPayload>
  /** Increase the count. */
  ...
  /** The payload for the updateVaga mutation */
  updateVaga?: Maybe<UpdateVagaPayload>
}
...
/** The root mutation */
export type RootMutationCreateVagaArgs = {
  input: CreateVagaInput
}
...
/** The root mutation */
export type RootMutationDeleteVagaArgs = {
  input: DeleteVagaInput
}
...
/** The root mutation */
export type RootMutationUpdateVagaArgs = {
  input: UpdateVagaInput
}
...
export type RootQuery = {
  ...
  vagas?: Maybe<RootQueryToVagaConnection>
...
/** The root entry point into the Graph */
export type RootQueryVagaArgs = {
  asPreview?: Maybe<Scalars['Boolean']>
  id: Scalars['ID']
  idType?: Maybe<VagaIdType>
}

/** The root entry point into the Graph */
export type RootQueryVagaByArgs = {
  id?: Maybe<Scalars['ID']>
  slug?: Maybe<Scalars['String']>
  uri?: Maybe<Scalars['String']>
  vagaId?: Maybe<Scalars['Int']>
}

/** The root entry point into the Graph */
export type RootQueryVagasArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<RootQueryToVagaConnectionWhereArgs>
}
...
/** Connection between the RootQuery type and the Vaga type */
export type RootQueryToVagaConnection = {
  __typename?: 'RootQueryToVagaConnection'
  /** Edges for the RootQueryToVagaConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToVagaConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Vaga>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type RootQueryToVagaConnectionEdge = {
...
/** Arguments for filtering the RootQueryToVagaConnection connection */
export type RootQueryToVagaConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars['Int']>
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars['ID']>>>
...
export type Tag = DatabaseIdentifier &
  ...
  UniformResourceIdentifiable & {
    ...
    /** The unique resource identifier path */
    uri?: Maybe<Scalars['String']>
    /** Connection between the tag type and the Vaga type */
    vagas?: Maybe<TagToVagaConnection>
  }
...
/** The tag type */
export type TagVagasArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<TagToVagaConnectionWhereArgs>
}
...
/** Connection between the tag type and the Vaga type */
export type TagToVagaConnection = {
  __typename?: 'TagToVagaConnection'
  /** Edges for the TagToVagaConnection connection */
  edges?: Maybe<Array<Maybe<TagToVagaConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Vaga>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type TagToVagaConnectionEdge = {
  __typename?: 'TagToVagaConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The item at the end of the edge */
  node?: Maybe<Vaga>
...
/** Arguments for filtering the TagToVagaConnection connection */
export type TagToVagaConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars['Int']>
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars['ID']>>>
...
/** Input for the updateVaga mutation */
export type UpdateVagaInput = {
  /** The userId to assign as the author of the object */
  authorId?: Maybe<Scalars['ID']>
  /** Set connections between the Vaga and categories */
  categories?: Maybe<VagaCategoriesInput>
...
export type User = Commenter &
  ...
  UniformResourceIdentifiable & {
    ...
    username?: Maybe<Scalars['String']>
    /** Connection between the User type and the Vaga type */
    vagas?: Maybe<UserToVagaConnection>
  }
...
/** A User object */
export type UserVagasArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<UserToVagaConnectionWhereArgs>
}
...
/** Connection between the User type and the Vaga type */
export type UserToVagaConnection = {
  __typename?: 'UserToVagaConnection'
  /** Edges for the UserToVagaConnection connection */
  edges?: Maybe<Array<Maybe<UserToVagaConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Vaga>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type UserToVagaConnectionEdge = {
  __typename?: 'UserToVagaConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The item at the end of the edge */
  node?: Maybe<Vaga>
...
/** Arguments for filtering the UserToVagaConnection connection */
export type UserToVagaConnectionWhereArgs = {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars['Int']>
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars['ID']>>>
...
export type Vaga = ContentNode &
  ...
  UniformResourceIdentifiable & {
    ...
    /** The globally unique identifier of the author of the node */
    authorId?: Maybe<Scalars['ID']>
    /** Connection between the Vaga type and the category type */
    categories?: Maybe<VagaToCategoryConnection>
    /** The content of the post. */
    content?: Maybe<Scalars['String']>
    /** Connection between the ContentNode type and the ContentType type */
    contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>
    ...
    /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
    modifiedGmt?: Maybe<Scalars['String']>
    /** Connection between the Vaga type and the Vaga type */
    preview?: Maybe<VagaToPreviewConnectionEdge>
    /** The database id of the preview node */
    previewRevisionDatabaseId?: Maybe<Scalars['Int']>
    /** Whether the object is a node in the preview state */
    previewRevisionId?: Maybe<Scalars['ID']>
    /** The Yoast SEO data of the Vaga */
    seo?: Maybe<PostTypeSeo>
    /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
    slug?: Maybe<Scalars['String']>
    /** The current status of the object */
    status?: Maybe<Scalars['String']>
    /** Connection between the Vaga type and the tag type */
    tags?: Maybe<VagaToTagConnection>
    /** The template assigned to a node of content */
    template?: Maybe<ContentTemplate>
    /** Connection between the Vaga type and the TermNode type */
    terms?: Maybe<VagaToTermNodeConnection>
    /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
    title?: Maybe<Scalars['String']>
    /** The unique resource identifier path */
    uri?: Maybe<Scalars['String']>
...
/** The Vaga type */
export type VagaCategoriesArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<VagaToCategoryConnectionWhereArgs>
}

/** The Vaga type */
export type VagaContentArgs = {
  format?: Maybe<PostObjectFieldFormatEnum>
}

/** The Vaga type */
export type VagaEnqueuedScriptsArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
...
/** The Vaga type */
export type VagaEnqueuedStylesheetsArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
...
/** The Vaga type */
export type VagaTagsArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<VagaToTagConnectionWhereArgs>
}

/** The Vaga type */
export type VagaTermsArgs = {
  after?: Maybe<Scalars['String']>
  before?: Maybe<Scalars['String']>
  first?: Maybe<Scalars['Int']>
  last?: Maybe<Scalars['Int']>
  where?: Maybe<VagaToTermNodeConnectionWhereArgs>
}

/** The Vaga type */
export type VagaTitleArgs = {
  format?: Maybe<PostObjectFieldFormatEnum>
}

/** Set relationships between the Vaga to categories */
export type VagaCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: Maybe<Scalars['Boolean']>
  /** The input list of items to set. */
  nodes?: Maybe<Array<Maybe<VagaCategoriesNodeInput>>>
}

/** List of categories to connect the Vaga to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type VagaCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: Maybe<Scalars['String']>
  /** The ID of the category. If present, this will be used to connect to the Vaga. If no existing category exists with this ID, no connection will be made. */
  id?: Maybe<Scalars['ID']>
  /** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: Maybe<Scalars['String']>
  /** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Set relationships between the Vaga to tags */
export type VagaTagsInput = {
  /** If true, this will append the tag to existing related tags. If false, this will replace existing relationships. Default true. */
  append?: Maybe<Scalars['Boolean']>
  /** The input list of items to set. */
  nodes?: Maybe<Array<Maybe<VagaTagsNodeInput>>>
}

/** List of tags to connect the Vaga to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type VagaTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: Maybe<Scalars['String']>
  /** The ID of the tag. If present, this will be used to connect to the Vaga. If no existing tag exists with this ID, no connection will be made. */
  id?: Maybe<Scalars['ID']>
  /** The name of the tag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: Maybe<Scalars['String']>
  /** The slug of the tag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection between the Vaga type and the category type */
export type VagaToCategoryConnection = {
  __typename?: 'VagaToCategoryConnection'
  /** Edges for the VagaToCategoryConnection connection */
  edges?: Maybe<Array<Maybe<VagaToCategoryConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Category>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type VagaToCategoryConnectionEdge = {
  __typename?: 'VagaToCategoryConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The Yoast SEO Primary category */
  isPrimary?: Maybe<Scalars['Boolean']>
...
/** Arguments for filtering the VagaToCategoryConnection connection */
export type VagaToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars['String']>
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars['Int']>
...
/** Connection between the Vaga type and the Vaga type */
export type VagaToPreviewConnectionEdge = {
  __typename?: 'VagaToPreviewConnectionEdge'
  /** The node of the connection, without the edges */
  node?: Maybe<Vaga>
}

/** Connection between the Vaga type and the tag type */
export type VagaToTagConnection = {
  __typename?: 'VagaToTagConnection'
  /** Edges for the VagaToTagConnection connection */
  edges?: Maybe<Array<Maybe<VagaToTagConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Tag>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type VagaToTagConnectionEdge = {
  __typename?: 'VagaToTagConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The Yoast SEO Primary post_tag */
  isPrimary?: Maybe<Scalars['Boolean']>
...
/** Arguments for filtering the VagaToTagConnection connection */
export type VagaToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars['String']>
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars['Int']>
...
/** Connection between the Vaga type and the TermNode type */
export type VagaToTermNodeConnection = {
  __typename?: 'VagaToTermNodeConnection'
  /** Edges for the VagaToTermNodeConnection connection */
  edges?: Maybe<Array<Maybe<VagaToTermNodeConnectionEdge>>>
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<TermNode>>>
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>
...
/** An edge in a connection */
export type VagaToTermNodeConnectionEdge = {
  __typename?: 'VagaToTermNodeConnectionEdge'
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>
  /** The item at the end of the edge */
  node?: Maybe<TermNode>
...
/** Arguments for filtering the VagaToTermNodeConnection connection */
export type VagaToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars['String']>
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars['Int']>
